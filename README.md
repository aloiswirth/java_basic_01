# Learning Java
This repo is forked from LinkedIn Learning course Learning Java. The full course is available from [LinkedIn Learning][lil-course-url].
The content deviates from the original content.
